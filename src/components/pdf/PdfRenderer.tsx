      ...
      <div className="h-14 w-full border-b border-zinc-200 flex items-center justify-between px-2">
        <div className="flex items-center gap-1.5">
          <Button
            ...
            onClick={() => {
              setCurrentPage(previousPage => (previousPage - 1 > 1 ? previousPage - 1 : 1));
          ...
          <div className="flex items-center gap-1.5">
            <Input
              ...
              className={cn('w-12 h-8 focus-visible:ring-white', errors.page && 'focus-visible:ring-red-500')}
            />
          ...
          <Button
            ...
            onClick={() => {
              setCurrentPage(previousPage => (previousPage + 1 > numPages! ? numPages! : previousPage + 1));
              setValue('page', String(currentPage + 1));
            }}
          >
        ...
        <div className="space-x-2">
          <DropdownMenu>
            <DropdownMenuTrigger asChild>
              <Button aria-label="zoom" variant="ghost" className="gap-1.5 focus-visible:ring-white">
