...
import { pricingItems } from '@/config/pricingItems';
          ...
          <TooltipProvider>
            {pricingItems.map(({ plan, tagline, quota, features }) => {
              ...
              return (
                ...
                >
                  {plan === 'Pro' && (
                    <div className="absolute -top-5 left-0 right-0 mx-auto w-32 rounded-full bg-gradient-to-r from-red-600 to-orange-600 px-3 py-2 text-sm font-medium text-white">
                      Upgrade now
                    </div>
                  )}
                  <div className="p-5">
                  ...
                  <div className="flex h-20 items-center justify-center border-b border-t border-gray-200 bg-gray-50">
                    <div className="flex items-center space-x-1">
                      <p>{quota.toLocaleString()} PDFs/mo includet</p>
